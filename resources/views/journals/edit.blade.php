...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="flex items-center justify-between mb-8">
            <h1 class="text-4xl font-extrabold bg-gradient-to-r from-pink-500 to-pink-700 bg-clip-text text-transparent drop-shadow">Edit Journal</h1>
            <a href="{{ route('journals.show', $journal->id) }}" class="bg-gray-600 hover:bg-gray-700 text-white font-bold py-3 px-6 rounded-lg shadow-lg transition-colors duration-200" onclick="showLoading('Loading page...', 'Please wait a moment')">
        ...
        <div class="bg-gray-800 rounded-2xl shadow-lg overflow-hidden">
            <form method="POST" action="{{ route('journals.update', $journal->id) }}" class="p-8">
                @csrf
                @method('PUT')
