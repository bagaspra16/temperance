    ...
    <div class="bg-gray-800 rounded-2xl shadow-lg overflow-hidden">
        ...
        @else
            <div class="text-center p-6 sm:p-8 lg:p-12">
                <img src="{{ asset('img/no-tasks.svg') }}" alt="No Tasks" class="mx-auto h-24 sm:h-32 lg:h-40 mb-6 sm:mb-8">
                <h2 class="text-2xl sm:text-3xl font-bold text-gray-100 mb-2">All Tasks Clear!</h2>
                <p class="text-gray-400 mb-6 sm:mb-8 max-w-md mx-auto text-sm sm:text-base">You have no pending tasks. Create a new task to get started or enjoy the peace of mind!</p>
                <a href="{{ route('tasks.create') }}" class="bg-pink-600 hover:bg-pink-700 text-white font-bold py-2.5 sm:py-3 px-4 sm:px-6 rounded-xl sm:rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300 inline-flex items-center gap-2 text-sm sm:text-base" onclick="showLoading('Memuat halaman...', 'Mohon tunggu sebentar')">
